...
Despite at first glance there appearing to be a large (`r mean_diff`) increase in mileage from automatic to manual, taking account of the correlations among other variables shows this influence to be somewhat less. What remains after accounting for the other variables is a modest 7% difference in gas mileage attributable to transmission type.
