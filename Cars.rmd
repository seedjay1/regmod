...
1. On the residuals vs fitted plot, There appears to be no particular pattern to the residuals, nor any obvious outliers.
...
4. There appear to a a couple of candidates for outliers (high leverage and high residual) in the data: the Chrysler Imperial and the Mercedes 230. Further investigation may determine these observations are better off excluded.
